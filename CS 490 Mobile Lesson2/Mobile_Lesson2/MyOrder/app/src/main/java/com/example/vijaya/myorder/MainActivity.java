...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        CheckBox chocolate = (CheckBox) findViewById(R.id.sausage_checked);
        ...
        Intent orderSumPage = new Intent(this, OrderSummary.class);
        orderSumPage.putExtra("orderSummary1", orderSummaryMessage);
        startActivity(orderSumPage);
    }
    ...
    public void sendEmail(View view) {
        ...
        EditText userInputNameView = (EditText) findViewById(R.id.user_input);
        String userInputName = userInputNameView.getText().toString();
        String recipients[] = userInputName.split(",");
